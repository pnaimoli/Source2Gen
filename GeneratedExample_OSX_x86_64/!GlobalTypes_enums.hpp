...
enum class modifierfunction : unsigned long
{
	...
	MODIFIER_PROPERTY_MAGICDAMAGEOUTGOING_PERCENTAGE = 28,
	MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE = 29,
	MODIFIER_PROPERTY_BASEDAMAGEOUTGOING_PERCENTAGE_UNIQUE = 30,
	MODIFIER_PROPERTY_INCOMING_DAMAGE_PERCENTAGE = 31,
	MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_PERCENTAGE = 32,
	MODIFIER_PROPERTY_INCOMING_PHYSICAL_DAMAGE_CONSTANT = 33,
	MODIFIER_PROPERTY_INCOMING_SPELL_DAMAGE_CONSTANT = 34,
	MODIFIER_PROPERTY_EVASION_CONSTANT = 35,
	MODIFIER_PROPERTY_NEGATIVE_EVASION_CONSTANT = 36,
	MODIFIER_PROPERTY_AVOID_DAMAGE = 37,
	MODIFIER_PROPERTY_AVOID_SPELL = 38,
	MODIFIER_PROPERTY_MISS_PERCENTAGE = 39,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS = 40,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_ILLUSIONS = 41,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE = 42,
	MODIFIER_PROPERTY_PHYSICAL_ARMOR_BONUS_UNIQUE_ACTIVE = 43,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_BONUS = 44,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_ITEM_UNIQUE = 45,
	MODIFIER_PROPERTY_MAGICAL_RESISTANCE_DECREPIFY_UNIQUE = 46,
	MODIFIER_PROPERTY_BASE_MANA_REGEN = 47,
	MODIFIER_PROPERTY_MANA_REGEN_CONSTANT = 48,
	MODIFIER_PROPERTY_MANA_REGEN_CONSTANT_UNIQUE = 49,
	MODIFIER_PROPERTY_MANA_REGEN_PERCENTAGE = 50,
	MODIFIER_PROPERTY_MANA_REGEN_TOTAL_PERCENTAGE = 51,
	MODIFIER_PROPERTY_HEALTH_REGEN_CONSTANT = 52,
	MODIFIER_PROPERTY_HEALTH_REGEN_PERCENTAGE = 53,
	MODIFIER_PROPERTY_HEALTH_BONUS = 54,
	MODIFIER_PROPERTY_MANA_BONUS = 55,
	MODIFIER_PROPERTY_EXTRA_STRENGTH_BONUS = 56,
	MODIFIER_PROPERTY_EXTRA_HEALTH_BONUS = 57,
	MODIFIER_PROPERTY_EXTRA_MANA_BONUS = 58,
	MODIFIER_PROPERTY_EXTRA_HEALTH_PERCENTAGE = 59,
	MODIFIER_PROPERTY_STATS_STRENGTH_BONUS = 60,
	MODIFIER_PROPERTY_STATS_AGILITY_BONUS = 61,
	MODIFIER_PROPERTY_STATS_INTELLECT_BONUS = 62,
	MODIFIER_PROPERTY_CAST_RANGE_BONUS = 63,
	MODIFIER_PROPERTY_ATTACK_RANGE_BONUS = 64,
	MODIFIER_PROPERTY_ATTACK_RANGE_BONUS_UNIQUE = 65,
	MODIFIER_PROPERTY_MAX_ATTACK_RANGE = 66,
	MODIFIER_PROPERTY_PROJECTILE_SPEED_BONUS = 67,
	MODIFIER_PROPERTY_REINCARNATION = 68,
	MODIFIER_PROPERTY_RESPAWNTIME = 69,
	MODIFIER_PROPERTY_RESPAWNTIME_PERCENTAGE = 70,
	MODIFIER_PROPERTY_RESPAWNTIME_STACKING = 71,
	MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE = 72,
	MODIFIER_PROPERTY_COOLDOWN_PERCENTAGE_STACKING = 73,
	MODIFIER_PROPERTY_CASTTIME_PERCENTAGE = 74,
	MODIFIER_PROPERTY_MANACOST_PERCENTAGE = 75,
	MODIFIER_PROPERTY_DEATHGOLDCOST = 76,
	MODIFIER_PROPERTY_PREATTACK_CRITICALSTRIKE = 77,
	MODIFIER_PROPERTY_PHYSICAL_CONSTANT_BLOCK = 78,
	MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK_UNAVOIDABLE_PRE_ARMOR = 79,
	MODIFIER_PROPERTY_TOTAL_CONSTANT_BLOCK = 80,
	MODIFIER_PROPERTY_OVERRIDE_ANIMATION = 81,
	MODIFIER_PROPERTY_OVERRIDE_ANIMATION_WEIGHT = 82,
	MODIFIER_PROPERTY_OVERRIDE_ANIMATION_RATE = 83,
	MODIFIER_PROPERTY_ABSORB_SPELL = 84,
	MODIFIER_PROPERTY_REFLECT_SPELL = 85,
	MODIFIER_PROPERTY_DISABLE_AUTOATTACK = 86,
	MODIFIER_PROPERTY_BONUS_DAY_VISION = 87,
	MODIFIER_PROPERTY_BONUS_NIGHT_VISION = 88,
	MODIFIER_PROPERTY_BONUS_NIGHT_VISION_UNIQUE = 89,
	MODIFIER_PROPERTY_BONUS_VISION_PERCENTAGE = 90,
	MODIFIER_PROPERTY_FIXED_DAY_VISION = 91,
	MODIFIER_PROPERTY_FIXED_NIGHT_VISION = 92,
	MODIFIER_PROPERTY_MIN_HEALTH = 93,
	MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PHYSICAL = 94,
	MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_MAGICAL = 95,
	MODIFIER_PROPERTY_ABSOLUTE_NO_DAMAGE_PURE = 96,
	MODIFIER_PROPERTY_IS_ILLUSION = 97,
	MODIFIER_PROPERTY_ILLUSION_LABEL = 98,
	MODIFIER_PROPERTY_SUPER_ILLUSION = 99,
	MODIFIER_PROPERTY_SUPER_ILLUSION_WITH_ULTIMATE = 100,
	MODIFIER_PROPERTY_TURN_RATE_PERCENTAGE = 101,
	MODIFIER_PROPERTY_DISABLE_HEALING = 102,
	MODIFIER_PROPERTY_OVERRIDE_ATTACK_MAGICAL = 103,
	MODIFIER_PROPERTY_UNIT_STATS_NEEDS_REFRESH = 104,
	MODIFIER_PROPERTY_BOUNTY_CREEP_MULTIPLIER = 105,
	MODIFIER_PROPERTY_BOUNTY_OTHER_MULTIPLIER = 106,
	MODIFIER_EVENT_ON_SPELL_TARGET_READY = 107,
	MODIFIER_EVENT_ON_ATTACK_RECORD = 108,
	MODIFIER_EVENT_ON_ATTACK_START = 109,
	MODIFIER_EVENT_ON_ATTACK = 110,
	MODIFIER_EVENT_ON_ATTACK_LANDED = 111,
	MODIFIER_EVENT_ON_ATTACK_FAIL = 112,
	MODIFIER_EVENT_ON_ATTACK_ALLIED = 113,
	MODIFIER_EVENT_ON_PROJECTILE_DODGE = 114,
	MODIFIER_EVENT_ON_ORDER = 115,
	MODIFIER_EVENT_ON_UNIT_MOVED = 116,
	MODIFIER_EVENT_ON_ABILITY_START = 117,
	MODIFIER_EVENT_ON_ABILITY_EXECUTED = 118,
	MODIFIER_EVENT_ON_ABILITY_FULLY_CAST = 119,
	MODIFIER_EVENT_ON_BREAK_INVISIBILITY = 120,
	MODIFIER_EVENT_ON_ABILITY_END_CHANNEL = 121,
	MODIFIER_EVENT_ON_PROCESS_UPGRADE = 122,
	MODIFIER_EVENT_ON_REFRESH = 123,
	MODIFIER_EVENT_ON_TAKEDAMAGE = 124,
	MODIFIER_EVENT_ON_STATE_CHANGED = 125,
	MODIFIER_EVENT_ON_ORB_EFFECT = 126,
	MODIFIER_EVENT_ON_ATTACKED = 127,
	MODIFIER_EVENT_ON_DEATH = 128,
	MODIFIER_EVENT_ON_RESPAWN = 129,
	MODIFIER_EVENT_ON_SPENT_MANA = 130,
	MODIFIER_EVENT_ON_TELEPORTING = 131,
	MODIFIER_EVENT_ON_TELEPORTED = 132,
	MODIFIER_EVENT_ON_SET_LOCATION = 133,
	MODIFIER_EVENT_ON_HEALTH_GAINED = 134,
	MODIFIER_EVENT_ON_MANA_GAINED = 135,
	MODIFIER_EVENT_ON_TAKEDAMAGE_KILLCREDIT = 136,
	MODIFIER_EVENT_ON_HERO_KILLED = 137,
	MODIFIER_EVENT_ON_HEAL_RECEIVED = 138,
	MODIFIER_EVENT_ON_BUILDING_KILLED = 139,
	MODIFIER_EVENT_ON_MODEL_CHANGED = 140,
	MODIFIER_PROPERTY_TOOLTIP = 141,
	MODIFIER_PROPERTY_MODEL_CHANGE = 142,
	MODIFIER_PROPERTY_MODEL_SCALE = 143,
	MODIFIER_PROPERTY_IS_SCEPTER = 144,
	MODIFIER_PROPERTY_TRANSLATE_ACTIVITY_MODIFIERS = 145,
	MODIFIER_PROPERTY_TRANSLATE_ATTACK_SOUND = 146,
	MODIFIER_PROPERTY_LIFETIME_FRACTION = 147,
	MODIFIER_PROPERTY_PROVIDES_FOW_POSITION = 148,
	MODIFIER_PROPERTY_SPELLS_REQUIRE_HP = 149,
	MODIFIER_PROPERTY_FORCE_DRAW_MINIMAP = 150,
	MODIFIER_PROPERTY_DISABLE_TURNING = 151,
	MODIFIER_PROPERTY_IGNORE_CAST_ANGLE = 152,
	MODIFIER_PROPERTY_CHANGE_ABILITY_VALUE = 153,
	MODIFIER_PROPERTY_ABILITY_LAYOUT = 154,
	MODIFIER_EVENT_ON_DOMINATED = 155,
	MODIFIER_PROPERTY_TEMPEST_DOUBLE = 156,
	MODIFIER_PROPERTY_PRESERVE_PARTICLES_ON_MODEL_CHANGE = 157,
