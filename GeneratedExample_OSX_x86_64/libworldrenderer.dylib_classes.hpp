...
// libworldrenderer.dylib, project entity2
// Alignment: 8
...
public:
char CScriptComponent_028[0x27];
	__declspec(align(8)) UnknownType <0x8, class CUtlSymbolLarge> m_scriptClassName;// 0x28, size 8 (0x8)
public:
	static EntComponentInfo_t Get_s_EntComponentInfo() {return *(EntComponentInfo_t *)schema::SchemaSystem::Get()->FindTypeScopeForModule("libworldrenderer.dylib")->FindDeclaredClass("CScriptComponent")->m_staticMembers.data[0].m_pInstance; }
	static int32_t Get_entity_component_error_class_decl_says_contained_but_impl_is_referenced() {return *(int32_t *)schema::SchemaSystem::Get()->FindTypeScopeForModule("libworldrenderer.dylib")->FindDeclaredClass("CScriptComponent")->m_staticMembers.data[1].m_pInstance; }
}; // size: 48 (0x30)
#pragma pack(pop)
